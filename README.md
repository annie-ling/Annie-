...
本版保留 V2 原有測驗與 Premium 後端設定，主要調整付費轉換流程：
- 感情測驗免費顯示：契合度、兩人的感情需求、最容易卡住的地方。
- 後續 6 個深度題目改為鎖定預覽，導向 NT$149 雙人感情深度解析。
- NT$590 Premium 完整人生解析保留，定位改為第二階段升級商品。
- 原有 Premium 解鎖碼 / Supabase 設定不變。

注意：NT$149 感情解析目前採 LINE 人工成交／交付，不共用 NT$590 Premium 解鎖碼，以免兩種商品權限混在一起。
